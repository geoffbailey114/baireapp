...
export const post: BlogPost = {
  ...
  faqs: [
    {
      question: 'Is buying a home as complicated as it feels?',
      answer: "No. The home-buying process follows a predictable, sequential checklist: get pre-approved, search for homes, make an offer, get an inspection, close. Each step has a clear purpose and defined timeline. The contracts are standardized fill-in-the-blank forms. The fear comes from encountering everything at once for the first time \u2014 not from any single step being difficult.",
    },
    {
      question: 'What is earnest money in simple terms?',
      answer: "Earnest money is a deposit that shows the seller you\u2019re serious about buying. If the deal closes, it goes toward your down payment. If it doesn\u2019t close and you\u2019re within your contingency terms, you get it back. It\u2019s typically 1\u20133% of the purchase price.",
    },
    {
      question: 'What are contingencies in a home purchase?',
      answer: "Contingencies are exit ramps built into your purchase contract. The inspection contingency lets you walk away if the home has major problems. The financing contingency protects you if your loan falls through. The appraisal contingency covers you if the home isn\u2019t worth what you offered. They\u2019re standard in nearly every transaction.",
    },
    {
      question: 'Can a first-time buyer really buy a home without an agent?',
      answer: "Yes. No state requires you to hire a buyer\u2019s agent. The MLS data that was once only available to agents is now on every listing portal. The contracts are publicly available templates. Inspections, appraisals, and title work are handled by independent professionals you hire directly. Many first-time buyers successfully self-represent.",
    },
    {
      question: 'What\u2019s the biggest obstacle for first-time home buyers?',
  ...
  content: () => (
    <>
      ...
      <p>
        Most of that fear is based on a misunderstanding of what buying a home actually involves. Not what it <em>feels</em> like. What it <em>involves</em>. Because the process itself&mdash;once you strip away the jargon and the anxiety&mdash;is more sequential and more manageable than almost anyone expects.
      </p>
      <p>
      ...
      <h2>Why First-Time Buyers Feel So Lost</h2>
      <p>
        There&apos;s a reason the home-buying process feels opaque, and it&apos;s not because it&apos;s genuinely complicated. It&apos;s because the people who understand it&mdash;agents, lenders, title companies&mdash;have no incentive to make it feel simple. Complexity justifies their fees. Mystery creates dependency.
      </p>
      <p>
      ...
      <h2>The Home-Buying Process Is a Checklist, Not a Mystery</h2>
      <p>
      ...
      <p>
        Each step has a clear purpose, a defined timeline, and a knowable set of decisions. The contracts are standardized forms&mdash;fill-in-the-blank templates approved by state regulatory bodies. The deadlines are written into the agreement. The professionals involved (lender, inspector, title company, appraiser) each handle their piece independently.
      </p>
      <p>
      ...
      <p>
        &quot;Earnest money&quot; is a deposit. It shows the seller you&apos;re serious. If the deal closes, it goes toward your down payment. If it doesn&apos;t close&mdash;and you&apos;re within your contingency terms&mdash;you get it back.
      </p>
      <p>
      ...
      <p>
        &quot;Closing costs&quot; are the fees associated with finalizing the loan and transferring ownership. They typically run 2&ndash;5% of the purchase price and include things like the appraisal fee, title insurance, recording fees, lender origination charges, and prepaid taxes and insurance. Your lender will give you a detailed estimate early in the process.
      </p>
      <p>
        &quot;Title search&quot; is a check to make sure the person selling you the house actually owns it free and clear&mdash;no liens, no disputes, no surprises.
      </p>
      <p>
      ...
      <h2>What Actually Goes Wrong (and What Doesn&apos;t)</h2>
      <p>
      ...
      <h3>&quot;I&apos;ll overpay because I don&apos;t know what the house is worth.&quot;</h3>
      <p>
      ...
      <h3>&quot;I&apos;ll mess up the negotiation and pay too much or lose the house.&quot;</h3>
      <p>
      ...
      <p>
        What&apos;s changed&mdash;and what many first-time buyers don&apos;t realize yet&mdash;is that the information landscape has shifted dramatically. The MLS data that was once only available to agents is now on every listing portal. The contracts are publicly available templates. The inspection, appraisal, and title processes are handled by independent professionals you hire directly. And the <a href="/blog/nar-settlement-explained">2024 NAR settlement</a> has made it clear that buyer-agent commissions aren&apos;t &quot;free&quot;&mdash;they&apos;re a cost that buyers fund, whether they realize it or not.
      </p>
      <p>
        This doesn&apos;t mean you should never use an agent. It means you should choose based on an honest assessment of what you need&mdash;not on the assumption that you can&apos;t do it without one. Because you can. Plenty of people do, including first-time buyers.
      </p>

      <h2>The Confidence Gap Is the Real Obstacle</h2>
      <p>
      ...
      <p>
        <strong>Next up:</strong> If you&apos;re a first-time buyer trying to separate what you actually need to know from the noise, our next guide cuts through the clutter: <a href="/blog/what-first-time-buyers-need-to-know">What First-Time Home Buyers Actually Need to Know (and What They Can Safely Ignore)</a>.
      </p>
    </>
  ),
}
