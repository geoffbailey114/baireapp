...
export const post: BlogPost = {
  ...
  tldr: 'The buyer\'s agent commission was never free. It was built into the sale price and paid by the seller — which means you, the buyer, financed it as part of your mortgage. On a $400K home at 2.5%, that\'s   description: "The 'seller pays' myth has cost home buyers billions. Here's how buyer agent commissions really work — and who's actually footing the bill.",0,000 upfront and over $20,000 when financed over 30 years at current rates.',
  ...
  faqs: [
    {
      question: "Does the seller really pay the buyer's agent commission?",
      answer: "Technically, the commission check comes from the seller's proceeds at closing. But the seller builds that cost into their asking price — which means the buyer finances it as part of the purchase price. On a 30-year mortgage, that embedded commission costs far more than the original amount due to interest.",
    },
    {
      question: "How much does a buyer's agent actually cost?",
      answer: "Buyer's agent commissions typically range from 2% to 3% of the home price. On a $400,000 home at 2.5%, that's $10,000 at closing — but financed over 30 years at 7%, the true cost is roughly $23,950 including interest.",
    },
    {
      question: 'What changed with the 2024 NAR settlement?',
      answer: "The NAR settlement ended the practice of advertising buyer agent commissions on MLS listings. Buyers must now sign a written agreement with their agent specifying compensation. For the first time, buyers are being forced to confront what their agent actually costs.",
    },
    {
      question: 'Can I buy a home without a buyer\'s agent?',
      answer: "Yes. There is no law in any state requiring you to hire a buyer's agent. You can search for homes, schedule showings, write offers, negotiate, and close — all on your own or with the help of an educational platform like BAIRE.",
    },
    {
      question: 'What is the opportunity cost of a buyer\'s agent commission?',
      answer: "Beyond the financed cost, there's an equity impact. A higher purchase price means lower starting equity, potentially longer PMI payments, and a higher break-even point if the market dips. The commission also raises your loan-to-value ratio on day one.",
    },
  ],
  content: () => (
    <>
      ...
      <h2>How the Commission Structure Has Worked for Decades</h2>
      <p>
      ...
      <h2>The Money Has to Come from Somewhere</h2>
      <p>
      ...
      <h2>Why This Myth Has Lasted So Long</h2>
      <p>
      ...
      <h2>The Part Nobody Talks About: Opportunity Cost</h2>
      <p>
      ...
      <h2>This Doesn&apos;t Mean Agents Are a Scam</h2>
      <p>
      ...
      <hr />
      <p>
        Understanding the true cost is the first step. But exactly how much does that commission add up to once it&apos;s baked into your mortgage? We break down the 30-year math in our next piece: <a href="/blog/true-cost-buyer-agent-30-year-mortgage">The True Cost of a Buyer&apos;s Agent on a 30-Year Mortgage</a>.
      </p>
    </>
  ),
}
