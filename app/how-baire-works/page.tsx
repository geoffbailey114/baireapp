          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="grid sm:grid-cols-2 gap-6 max-w-2xl mx-auto mb-12">
              ...
              <div className="bg-white rounded-2xl border border-slate-200 p-8 text-center">
                ...
                <p className="text-4xl font-bold text-[#C4695E] mb-2">$10,000–$15,000</p>
              ...
              {/* BAIRE card */}
              <div className="bg-[#3d4a3d] rounded-2xl p-8 text-center text-white">
            ...
            <p className="text-slate-600 max-w-lg mx-auto leading-relaxed">
              A buyer&apos;s agent can&apos;t give you legal advice. Can&apos;t do your inspection. Can&apos;t appraise the home. What they <em>can</em> do — schedule showings, pull comps, coach you through offers — BAIRE does for 90% less.
            </p>
          </div>
        </div>
      </section>
