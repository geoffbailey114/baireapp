        ...
        <div className="mx-auto max-w-4xl">
          ...
          >
            <p className="text-lg text-slate-600 leading-relaxed mb-8">
              ...
              When two buyers bid the same amount, the one without an agent&apos;s commission attached is the better deal for the seller — every time.
            </p>
            ...
            <div className="flex flex-wrap gap-3 justify-center">
              {advantages.map((adv, i) => (
                <span
                  key={i}
                  className="inline-flex items-center gap-2 bg-sage-50 border border-sage-200 text-sage-700 text-sm font-medium px-4 py-2 rounded-full"
                >
